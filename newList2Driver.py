from NewList2 import SingleList

duplicates = [1, 2, 2, 3, 4, 3, 6, 9 ]
print "List with duplicates is:", duplicates

single = SingleList(duplicates) #Create single list object
print "SingleList, created from duplicates, is:", single
print "The lenghth of the list is:", len(single)

#search for values in list
print "\nThe value 2 appears %d times in the list" % single.count(2)
